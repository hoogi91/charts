...
class ColorPaletteInputElement extends HTMLElement {
    ...
    renderPreview() {
        ...
        this.colorPalette.addEventListener('click', () => {
            ...
            const modalContent = createElement('div', {
                ...
                append: [createElement('color-palette', {ref: this.ref})]
            });
    ...
    renderPaletteContent() {
        if (this.value.length === 0 && this.mode === 'preview') {
            this.colorPalette.innerHTML = '<div class="new-palette">neue Farbpalette erstellen</div>';
            return;
        }
        ...
        if (this.value.length === 0) {
            const startButton = createElement('button', {
                class: 'start-button',
                innerHTML: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><g class="icon-color"><path d="M11.5 10.6c-.2.1-.4.1-.6.1-1.8 0-4.4-6.2-4.4-8.3 0-.8.2-1 .4-1.2-2.1.3-4.7 1.1-5.5 2.1-.2.2-.3.6-.3 1.1C1.1 7.7 4.5 15 7 15c1.1 0 3-1.8 4.5-4.4M10.4 1c2.2 0 4.5.4 4.5 1.6 0 2.6-1.6 5.7-2.5 5.7-1.5 0-3.3-4.1-3.3-6.2 0-.9.4-1.1 1.3-1.1"/></g></svg><br/>starten'
            });
